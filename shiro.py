...
async def on_message(message):
    if message.content.startswith(pfx + 'count'):
        ...
        print('CMD [sleep] > Sleep invoked...by: ' + str(message.author) + ' ,UserID: ' + message.author.id + '. Server: ' + message.server.id)
        ...
        print('CMD [function] > Function check triggered. by: ' + str(message.author) + ' ,UserID: ' + message.author.id + '. Server: ' + message.server.id)
    elif message.content.startswith(pfx + 'die'):
        await client.send_message(message.channel, 'Shiro shutting off... Good bye!')
        print('CMD [die] > Shutting off...by: ' + str(message.author) + ' ,UserID: ' + message.author.id + '. Server: ' + message.server.id)
        ...
        print('CMD [echo] > Manual echo invoked with messsage: ' + message.content[5 + len(pfx):] + 'by: ' + str(message.author) + ' ,UserID: ' + message.author.id + '. Server: ' + message.server.id)
        ...
        print('CMD [hentai] > Pervy perv~ by: ' + str(message.author) + ' ,UserID: ' + message.author.id + '. Server: ' + message.server.id)
    elif message.content.startswith(pfx + 'time'):
        await client.send_message(message.channel, current_time)
        print('CMD [time] > Time Written: ' + str(current_time) + 'by: ' + str(message.author) + ' ,UserID: ' + message.author.id + '. Server: ' + message.server.id)
    elif message.content.startswith(pfx + 'pcstats'):
        await client.send_message(message.channel,
                                  '**MEM Stats:** \n' + str(psutil.virtual_memory()) + '\n\n **CPU Stats:** \n' + str(
                                      psutil.cpu_stats()) + '\n\n **CPU Percent:** \n' + str(
                                      psutil.cpu_percent(percpu=True)))
        print('CMD [pcstats] > Host PC Stats Checked by: ' + str(message.author) + ' ,UserID: ' + message.author.id + '. Server: ' + message.server.id)
    elif message.content.startswith('<@207266746594361344>'):
        await client.send_message(message.channel, 'Nani desu ka?')
        print('CMD [mentioned] > Metioned by user: ' + str(message.author) + ' ,UserID: ' + message.author.id + '. Server: ' + message.server.id)
        ...
        print('CMD [invite] > Invite Link Generated by: ' + str(message.author) + ' ,UserID: ' + message.author.id + '. Server: ' + message.server.id)
    elif message.content.startswith(pfx + 'help'):
        await client.send_message(message.channel,
                                  'I am still very new so the only things I can do are:\n`' + pfx + 'test`\n`' + pfx + 'sleep`\n`' + pfx + 'echo`\n`' + pfx + 'time`\n`' + pfx + 'pcstats`\n`' + pfx + 'invite`\n\n **Have fun~**')
        print('CMD [help] > Help requested by: ' + str(message.author) + ' ,UserID: ' + message.author.id + '. Server: ' + message.server.id)
        ...
        print('CMD [owner] > The owner ID check triggered by ' + str(message.author) + ' ,UserID: ' + message.author.id + '. Server: ' + message.server.id)
        ...
        print('CMD [report] > Report submitted by ' + str(message.author) + ' ,UserID: ' + message.author.id + '. Server: ' + message.server.id)
